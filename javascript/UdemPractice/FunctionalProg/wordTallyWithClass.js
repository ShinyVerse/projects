...
class WordCount {
  ...
  content() {
    ...
    return "The dog went up the tree because that's what a dog can do in this sentence, all crazy things like that. And more than that he could dance like Beyonce. Dogs are not known for their dancing abilities, but this dog was the master of all crazy stuff like that."
  }
